...
if st.button("리뷰 가져오기 및 분석"):
    reviews = ["저는 하체 근육이 심해서 이만기 장딴지예요..여성 의류는 와이드바지를 사도 종아리쪽 사이즈가 작아서 종아리근육이 더 도드라지더라구요ㅜㅜ 몇번의 실패후 걍 남자팬츠로 찾아보는데 스판도 좋고 시원하다고 해서 하나 질러봤습니다. 진짜 바지가 차갑습니다!! 바로 착용해보니 스판 장난아니고 아빠다리 하고 앉아봤는데 미춌어요. 한시간 앉을수있을각. 진짜 편합니다. 주머니에 손 넣어보니 제법 주머니도 깊어서 완전 맘에 드네요! 특이점이 있다면 와이드 바지인만큼 통이커요~! 모델분이 사진마다 주머니에 손을 넣는데에는 이유가 있던, 근데 저는 와이드를 원했기에 통이 커도 상관없었어요~ 회사에 입고가도 재질이 고무줄팬츠같지 않아서 괜찮을것같아요~ 무튼 저는 2개 더 살랍니다 착용해봤는데 편하고 진짜 만족해요."]
